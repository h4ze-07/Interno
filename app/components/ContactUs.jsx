...
const ContactUs = () => {
  return (
    <section className="lg:mt-[100px] lg:mb-[140px] max-w-[1200px] flex flex-col lg:flex-row justify-between">
        <article className="flex flex-col md:flex-row lg:block md:items-end gap-4 px-5">
            ...
            <motion.div className="hidden lg:flex gap-[20px] pt-[12px]"
                variants={generateVariant('left')}
                initial='initial'
                whileInView='view'
                transition={generateDuration()}
            ...
            <div className="hidden lg:block mb-[36px]">
                <SectionButton text='Get Free Estimate' animatePosition='left' />
            </div>
            ...
            >
                ...
                <div className="mb-[10px]">
                    <SectionButton text='Get Free Estimate' animatePosition='right' />
                </div>
            </motion.div>
